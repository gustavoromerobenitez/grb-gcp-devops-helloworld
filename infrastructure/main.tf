...
provider "kubernetes" {
  version = "~> 1.10"
  host = data.terraform_remote_state.current-project.google_container_cluster.container-cluster.endpoint
  insecure = "false"
  client_certificate = base64decode(data.terraform_remote_state.current-project.google_container_cluster.container-cluster.master.auth[0].client_certificate)
  client_key = base64decode(data.terraform_remote_state.current-project.google_container_cluster.container-cluster.master.auth[0].client_key)
  cluster_ca_certificate = base64decode(data.terraform_remote_state.current-project.google_container_cluster.container-cluster.master.auth[0].cluster_ca_certificate)
}
